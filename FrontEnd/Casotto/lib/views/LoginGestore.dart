...
class LoginGestoreView extends StatefulWidget {
  const LoginGestoreView({Key? key}) : super(key: key);

  static const String routeName = "LoginGestore";

  @override
  State<LoginGestoreView> createState() => _LoginGestoreViewState();
}

class _LoginGestoreViewState extends State<LoginGestoreView> {
  UtenteService utenteService = new UtenteService();
  @override
  Widget build(BuildContext context) {
    return FlutterLogin(
      title: "Casotto gestori",
